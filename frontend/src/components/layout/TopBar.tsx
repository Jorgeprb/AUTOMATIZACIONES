...
export function TopBar({ onOpenMenu }: { onOpenMenu: () => void }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-18 items-center justify-between border-b border-[#e8ebf0] bg-white/90 px-4 backdrop-blur-xl sm:px-6">
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:block">
          <p className="text-xs font-medium text-[#8b95a6]">Espacio de trabajo</p>
      ...
      <div className="relative w-full max-w-[280px]">
        ...
        >
          {!clinics.length ? (
            <option value="">Sin clínicas</option>
          ) : null}
          {clinics.map((clinic) => (
