...
class Settings(BaseSettings):
    ...
    admin_bootstrap_password: SecretStr = SecretStr("change-this-in-production")
    ...
    smtp_from_email: str = ""
    smtp_from_name: str = "Autogal"
    smtp_use_tls: bool = True
    stripe_secret_key: SecretStr = SecretStr("")
    stripe_publishable_key: str = ""
    stripe_webhook_secret: SecretStr = SecretStr("")
    stripe_phone_price_id: str = ""
    stripe_monthly_service_price_id: str = ""
    stripe_success_url: str = ""
    stripe_cancel_url: str = ""
    stripe_customer_portal_return_url: str = ""
    call_analysis_model: str = "gpt-5.6-luna"
    call_analysis_enabled: bool = True
    demo_phone_number: str = "+34881170837"
