...
export function SettingsPage() {
  ...
  return (
    <div className="space-y-7">
      <PageHeader title="Configuración" description="Estado operativo y seguridad de la sesión administrativa." />
