  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f6f8fb] px-4 py-10">
      <Card className="w-full max-w-md">
        <CardHeader>
          <div className="mb-3 flex size-11 items-center justify-center rounded-2xl bg-[#315efb] text-lg font-bold text-white">C</div>
          <CardTitle>Entrar al panel</CardTitle>
          <CardDescription>
            Acceso protegido mediante una sesión segura y revocable del servidor.
          </CardDescription>
        </CardHeader>
        <CardContent>
